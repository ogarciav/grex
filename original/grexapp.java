// grexapp.java --- Conversion of applet to application
//    Follows http://www.rgagnon.com/javadetails/java-0305.html
...
// For app:
public class grexapp extends Panel implements MouseInputListener, ItemListener {
 
// For app:
public static void main(String[] args) {
    Frame frm = new Frame("Growth-curve Explorer");
    frm.addWindowListener(new java.awt.event.WindowAdapter() {
       public void windowClosing(java.awt.event.WindowEvent e) {
       System.exit(0);
       };
     });
    grexapp grx = new grexapp();
    grx.setSize(640, 610);
    frm.add(grx);
    frm.pack();
    grx.init();
    frm.setSize(620, 610 + 60);
    frm.show();
}
...
//    Image img;  // alternative, does not seem to work
    ...
    public void init() {
	    ...
	    String parameter = null; // getParameter("NPOINTS");  ** for app **
	    if (parameter != null) {
		    try {
		...
		parameter = null;  // getParameter("SPACING");
	    ...
	    parameter = null;  // getParameter("CUTOFF");
	    if (parameter != null) {
		    try {
        ...
        try {
//	        img = ImageIO.read(new URL(getCodeBase(), "grex.png")); For app:
	        img = ImageIO.read(new File("grex.png"));
	    } catch (IOException e) {
		}
